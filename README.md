...
制糖工厂小电拼 自带 MQTT 接入功能，但启用 MQTT 会导致官方 App 失效。本集成**基于 AI 智能体开放的 MCP 协议**开发，无需占用独占协议：

| 接入方式 | 官方 App | Home Assistant | 特点 |
| :--- | :---: | :---: | :--- |
| **MQTT (官方)** | ❌ | ✅ | 协议独占，App 无法使用 |
| **MCP (本集成)** | ✅ | ✅ | **双端共存，互不干扰** |
...
<details>
<summary><b>👉 点击展开：单端口实体列表 (5 端口 × 24 个)</b></summary>
...
<details>
<summary><b>👉 点击展开：设备级实体列表 (7 个)</b></summary>
